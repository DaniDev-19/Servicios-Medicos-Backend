...
const { getAllMedicamentos, createMedicamento, getMedicamento, updateMedicamento, deleteMedicamento, getCategoriaM, getAllMovimientos, getMedicamentosByPaciente } = require('../controllers/medicamentos.controller');
...
router
    ...
    .get(verificarToken, checkPermisos('medicamentos', 'ver'), getAllMovimientos);
...
router.get('/paciente/:id', verificarToken, checkPermisos('medicamentos', 'ver'), getMedicamentosByPaciente);
