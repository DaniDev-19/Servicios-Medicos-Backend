...
const createCategoriaM = async (req, res, next) => {
    ...
    try{
        ...
        const result = pool.query('INSERT INTO categoria_m  (nombre) VALUES ($1) RETURNING *', [nombre]);
...
const updateCategoriaM = async (req, res, next) => {
    ...
    try{
        ...
        const result = await pool.query('UPDATE categoria_m  SET nombre = $1 WHERE id = $2' ,[nombre, id]); 
